  ...
  <div class="justify-center items-center d-flex absolute-full">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 text-center">
        ...
        <span class="q-my-xl"><br></span>
        <!-- <span class="q-my-xl"><br></span> -->
        <div v-show="modalPedidos" class="q-ma-xs-md q-ma-lg-sm animated zoomIn">
        ...
        <div v-if="rows.length > 0" v-show="!modalPedidos" transition-show="slide-up" transition-hide="slide-down" class="q-ma-xs-md q-ma-lg-sm animated zoomIn ">
            ...
            <template v-slot:body-cell-opciones="props">
              <td>
                ...
                <q-btn class="botonEditar">
                  <span v-if="props.row.state == 1" @click="inactivedOrder(props.row._id)"><i class="bi bi-toggle-on text-success"></i></span>
