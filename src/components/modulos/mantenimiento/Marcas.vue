          ...
          <q-table title="Marcas" :rows="rows" :columns="columns" row-key="id" no-data-label="No existen datos!"
            ...
            <template v-slot:top="props">
              ...
              <div class="col-6" align="right">
                <q-btn class="colorEnfasis" style="font-size: 14px; background:#ffffff6b ; color: white;" @click="alert = true" glossy label="Crear Marca" />
            ...
            <template v-slot:body-cell-state="props">
              <td>
                <q-checkbox color="green" v-model="props.row.state" :true-value="1" :false-value="0" @click="editarEstado(props.row)" />
              </td>
            </template>
