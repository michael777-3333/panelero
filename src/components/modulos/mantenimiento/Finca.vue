                    ...
                    <q-table title="fincas" :rows="rows" :columns="columns" row-key="id" no-data-label="No existen datos!"
                        ...
                        <template v-slot:top="props">
                          ...
                          <div class="col-6" align="right">
                            <q-btn class="" @click="alert = true" style="font-size: 14px; background:#ffffff6b ; color: white;" glossy label="Crear Finca" />
          ...
          <q-card-section class="q-pt-none">
            <q-card class="lotesCard d-flex " >
              ...
              <q-card-actions align="center">
                <q-btn @click="createfinca()" style="bottom: green; color: white;" class="q-my-md bg-green" label="Crear Finca" />
...
{ name: "dueno finca", label: "dueno finca", field: "ownerFarm" },
