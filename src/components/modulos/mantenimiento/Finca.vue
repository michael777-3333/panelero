      ...
      <div v-show="fincaForm" class="q-ma-xs-md q-ma-lg-sm animated zoomIn">
        ...
        <q-card-section class="bgColorEnfasis q-pt-none">
          <q-card class="d-flex">
            <q-card-section>
              <div class="row">
                ...
                <div class="col-xs-6 col-md-4 q-pa-xs-sm q-px-sm-md q-px-sm-lg" style="text-align: center;">
                  <q-select filled v-model="name" :options="optionsCustomers" label="name" stack-label :dense="dense"
                    :options-dense="denseOpts" />
                </div>

                <div class="col-xs-6 col-md-4 q-pa-xs-sm q-px-sm-md q-px-sm-lg">
                  <q-select filled v-model="ownerFarm" :options="optionsStatus" label="dueño" stack-label :dense="dense"
                    :options-dense="denseOpts" />
                </div>
                <!-- <div class="col-xs-6 col-md-4 q-pa-xs-sm q-px-sm-md q-px-sm-lg">
          ...
          <div align="right" class="q-mt-md">
            <q-btn @click="fincaFormr = !fincaFormr" class="bg-red text-white q-mx-sm" label="Cerrar" />
      ...
      <div v-if="rows.length > 0" v-show="!fincaForm && !fincaFormr" transition-show="slide-up"
        ...
        <q-table :rows="rows" :columns="columns" row-key="id" no-data-label="No existen fincas!"
          ...
          <template v-slot:body-cell-opciones="props">
            <td>
              <q-btn class="botonEditar" style="background-color: #029127;" @click="editFinca(props.row)">
        ...
        <q-card-section class="q-pt-none">
          <q-card class="marcasCard d-flex">
            ...
            <q-card-actions align="center">
              <q-btn @click="createMarca()" style="background-color: green; color: white; " sclass="q-my-md colorEnfasis">Crear Marca</q-btn>
